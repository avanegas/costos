            ...
            <ul class="navbar-nav justify-content-right">
                ...
                <li class="nav-item" v-if="auth">
                    ...
                    <nav class="submenu">
                        ...
                        <router-link class="nav-link" :to="`/profiles/${authState.user_id}`" v-if="auth" >Perfil</router-link>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarsDefault">
                ...
                <ul class="navbar-nav justify-content-right">
                    ...
                    <li class="nav-item dropdown" v-if="auth">
                        <a class="nav-link dropdown-toggle" href="http://example.com" id="dropdown03" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ authState.user_id }}</a>
                        <div class="dropdown-menu" aria-labelledby="dropdown03">
